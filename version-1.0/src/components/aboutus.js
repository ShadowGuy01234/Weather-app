...
import './aboutus.css';
import image1 from '../../src/images/ab1.jpg'; 
import image2 from '../../src/images/na2.jpg';
import image3 from '../../src/images/hm3.jpg'; 
import image4 from '../../src/images/bp4.jpg'; 
import image5 from '../../src/images/dg5.jpg';
    ...
    <div className="about-us-container">
          ...
          {teamMembers.map((member, index) => (
            <div className="team-member-card" key={index}>
              ...
              <div className="connect-with-us"> 
                Connect with us:
                {member.linkedin && <a href={member.linkedin} target="_blank" rel="noopener noreferrer"><FaLinkedin className="social-icon" /></a>}
                {member.github && <a href={member.github} target="_blank" rel="noopener noreferrer"><FaGithub className="social-icon" /></a>}
                {member.instagram && <a href={member.instagram} target="_blank" rel="noopener noreferrer"><FaInstagram className="social-icon" /></a>}
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="bottom-sections-container">
        <section className="mission-section">
          ...
          <p style={{ fontFamily: 'Lato, sans-serif'}}>Welcome to our weather forecast website! 
            <p></p>Our mission is to provide you with accurate weather information to help you plan your day and stay informed about changing conditions. The site uses up-to-date forecasts.</p>
        </section>
        <section className="contact-section">
          <h3>Contact Us</h3>
          <p style={{ fontFamily: 'Lato, sans-serif'}}> We value your feedback and are here to assist you.  
