    ...
    <nav className="bg-gradient-to-r from-blue-600 to-blue-800 shadow-lg">
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0 flex items-center">
              ...
              <span className="ml-2 text-white text-xl font-semibold">
                Weather<span className="font-light">Pro</span>
              </span>
            </div>
      ...
      <div className={`md:hidden ${mobileMenuOpen ? "block" : "hidden"}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-blue-700">
          ...
          <a
            href="/about"
            className="text-blue-200 hover:text-white block px-3 py-2 rounded-md text-base font-medium hover:bg-blue-600 transition duration-300"
          >
            About
          </a>
          <a
